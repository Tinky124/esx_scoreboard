...
TriggerEvent('es:addGroupCommand', 'srefresh', 'admin', function(source, args, user)
	AddPlayersToScoreboard()
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1System', 'You dont have permission to do this.' } })
end, {help = "Refresh scoreboard!"})

TriggerEvent('es:addGroupCommand', 'stoggleid', 'admin', function(source, args, user)
	TriggerClientEvent('esx_scoreboard:toggleID', source)
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1System', 'You dont have permission to do this.' } })
end, {help = "Toggle ID on scoreboard!"})
